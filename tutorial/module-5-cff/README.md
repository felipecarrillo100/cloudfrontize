...
### 🔴 Advanced
4. [A/B Testing Router](advanced/exercise-7-ab-router.md) – Implement simple cookie-based A/B routing.
5. [Dynamic Header Policy](advanced/exercise-8-header-policy.md) – Enforce security headers at the edge.
6. [Rate Gate](advanced/exercise-9-rate-gate.md) – Limit requests based on a header counter.

### 🏆 Pro
10. [Cookie Gate (Pro)](pro/exercise-10-rate-gate-pro.md) – Implement a stateful rate-limit loop using the "Sandwich" architecture.
11. [Variable Baker (CFF)](pro/exercise-11-variable-baker.md) – Mastering build-time injection within the 10KB CFF limit.
